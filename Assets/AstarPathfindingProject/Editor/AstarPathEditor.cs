...
using Assets.AstarPathfindingProject.Editor.GraphEditors;
...
namespace Assets.AstarPathfindingProject.Editor
{
	 ...
	 */
	  ...
	  * \see LoadStyles */
        ...
        static SerializeSettings serializationSettings = SerializeSettings.All;
            ...
            if ( fadeArea.Show () ) {
                ...
                if (GUILayout.Button ("Load from file")) {
                    ...
                    if (path != "") {
                        byte[] bytes;
                        try {
                            bytes = AstarSerializer.LoadFromFile (path);
                        } catch (System.Exception e) {
