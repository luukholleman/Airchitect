...
using UnityEngine;
using Guid = Assets.AstarPathfindingProject.Utilities.Guid;
#if NETFX_CORE
...
namespace Assets.AstarPathfindingProject.Core.Serialization
{
	...
	public class GuidConverter : JsonConverter {
		public override bool CanConvert (Type type) {
			return System.Type.Equals ( type, typeof(Guid) );
		}
