...
using Assets.AstarPathfindingProject.Core.Serialization;
using Assets.AstarPathfindingProject.Generators.NodeClasses;
using Assets.AstarPathfindingProject.Generators.Utilities;
using Assets.AstarPathfindingProject.Generators.Utilities.Voxels;
using Assets.AstarPathfindingProject.Modifiers;
...
namespace Assets.AstarPathfindingProject.Generators {
	[System.Serializable]
	[JsonOptIn]
